"""
AWS Lambda function for sending weekly InfraSketch usage reports.
This function is triggered by EventBridge on a schedule (every Monday).
"""
...
# Configuration
SENDER_EMAIL = "mattafrank2439@gmail.com"
...
def send_email(report):
    ...
    subject = f"📊 InfraSketch Weekly Report - {report['period']['start']} to {report['period']['end']}"
